...
public class Main {
    ...
    public static Shape getMaxArea(Shape[] array, int numberLargest) {
        Arrays.sort(array, new ShapesAreasComparator());
        return array[numberLargest - 1];
    }

    public static Shape getMaxPerimeter(Shape[] array, int numberLargest) {
    ...
    public static void main(String[] args) {
        ...
        Shape maxArea = getMaxArea(shapes, 1);
        Shape secondMaxPerimeter = getMaxPerimeter(shapes, 2);
