...
import static sukhov.matrix.Matrix.matrixMultiplication;
...
public class Main {
    public static void main(String[] args) {
        ...
        Matrix matrix4 = new Matrix(3, 5);
        Matrix copyMatrix1 = new Matrix(matrix1);

        matrix1.addition(copyMatrix1);
        Matrix matrix6 = subtraction(matrix1, copyMatrix1);
        Matrix matrix5 = matrixMultiplication(matrix2, matrix1);
        Matrix transposeMatrixMatrix3 = matrix3.transposeMatrix();
        matrix2.scalarMultiplication(6);

        System.out.println("Сумма матрицы 1 и ее копия = " + matrix1);
        System.out.println("Разность матрица 2 и матрица 1 = " + matrix6);
        System.out.println("Транспонирование матрицы 3 = " + transposeMatrixMatrix3);
        System.out.println("Умножение матрицы 2 и 1 = " + matrix5);
        System.out.println("Определителя матрицы 8  = " + matrix8.getMatrixDeterminant());
        System.out.println("Умножение матрицы 2 на скаляр = " + matrix2);
        System.out.println("Умножение матрицы 8 на вектор 3 = " + matrix8.vectorMultiplication(vector3));
    }
}
